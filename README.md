...
|题号|题目|通过率|难度|收藏|
|:-:|:-|:-: | :-: | :-: |
|[1015](https://leetcode.com/problems/numbers-with-repeated-digits/)| * Numbers With Repeated Digits :new: |30%|Hard||
...
|[0943](https://leetcode.com/problems/find-the-shortest-superstring/)| * Find the Shortest Superstring|35%|Hard||
...
|[0935](https://leetcode.com/problems/knight-dialer/)| * Knight Dialer|38%|Medium||
...
|[0932](https://leetcode.com/problems/beautiful-array/)| * Beautiful Array|51%|Medium||
|[0931](https://leetcode.com/problems/minimum-falling-path-sum/)| * Minimum Falling Path Sum|57%|Medium||
|[0930](https://leetcode.com/problems/binary-subarrays-with-sum/)| * Binary Subarrays With Sum|36%|Medium||
|[0929](https://leetcode.com/problems/unique-email-addresses/)| * Unique Email Addresses|75%|Easy||
...
|[0919](https://leetcode.com/problems/complete-binary-tree-inserter/)| * Complete Binary Tree Inserter|54%|Medium||
|[0918](https://leetcode.com/problems/maximum-sum-circular-subarray/)| * Maximum Sum Circular Subarray|30%|Medium||
...
|[0910](https://leetcode.com/problems/smallest-range-ii/)| * Smallest Range II|22%|Medium||
|[0909](https://leetcode.com/problems/snakes-and-ladders/)| * Snakes and Ladders|30%|Medium||
|[0908](https://leetcode.com/problems/smallest-range-i/)| * Smallest Range I|64%|Easy||
|[0907](https://leetcode.com/problems/sum-of-subarray-minimums/)| * Sum of Subarray Minimums|25%|Medium||
|[0906](https://leetcode.com/problems/super-palindromes/)| * Super Palindromes|29%|Hard||
|[0905](https://leetcode.com/problems/sort-array-by-parity/)| * Sort Array By Parity|72%|Easy||
|[0904](https://leetcode.com/problems/fruit-into-baskets/)| * Fruit Into Baskets|40%|Medium||
|[0903](https://leetcode.com/problems/valid-permutations-for-di-sequence/)| * Valid Permutations for DI Sequence|41%|Hard||
|[0902](https://leetcode.com/problems/numbers-at-most-n-given-digit-set/)| * Numbers At Most N Given Digit Set|27%|Hard||
...
|[0894](https://leetcode.com/problems/all-possible-full-binary-trees/)| * All Possible Full Binary Trees|69%|Medium||
...
|[0889](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-postorder-traversal/)| * Construct Binary Tree from Preorder and Postorder Traversal|58%|Medium||
...
|[0882](https://leetcode.com/problems/reachable-nodes-in-subdivided-graph/)| * Reachable Nodes In Subdivided Graph|36%|Hard||
...
|[0875](https://leetcode.com/problems/koko-eating-bananas/)| * Koko Eating Bananas|44%|Medium||
...
|[0863](https://leetcode.com/problems/all-nodes-distance-k-in-binary-tree/)| * All Nodes Distance K in Binary Tree|45%|Medium||
...
|[0857](https://leetcode.com/problems/minimum-cost-to-hire-k-workers/)| * Minimum Cost to Hire K Workers|46%|Hard||
...
|[0854](https://leetcode.com/problems/k-similar-strings/)| * K-Similar Strings|32%|Hard||
...
|[0851](https://leetcode.com/problems/loud-and-rich/)| * Loud and Rich|46%|Medium||
|[0850](https://leetcode.com/problems/rectangle-area-ii/)| * Rectangle Area II|43%|Hard||
|[0849](https://leetcode.com/problems/maximize-distance-to-closest-person/)| * Maximize Distance to Closest Person|40%|Easy||
|[0848](https://leetcode.com/problems/shifting-letters/)| * Shifting Letters|39%|Medium||
|[0847](https://leetcode.com/problems/shortest-path-visiting-all-nodes/)| * Shortest Path Visiting All Nodes|45%|Hard||
|[0846](https://leetcode.com/problems/hand-of-straights/)| * Hand of Straights|48%|Medium||
|[0845](https://leetcode.com/problems/longest-mountain-in-array/)| * Longest Mountain in Array|33%|Medium||
...
|[0838](https://leetcode.com/problems/push-dominoes/)| * Push Dominoes|42%|Medium||
|[0837](https://leetcode.com/problems/new-21-game/)| * New 21 Game|30%|Medium||
|[0836](https://leetcode.com/problems/rectangle-overlap/)| * Rectangle Overlap|45%|Easy||
|[0835](https://leetcode.com/problems/image-overlap/)| * Image Overlap|50%|Medium||
|[0834](https://leetcode.com/problems/sum-of-distances-in-tree/)| * Sum of Distances in Tree|38%|Hard||
...
|[0826](https://leetcode.com/problems/most-profit-assigning-work/)| * Most Profit Assigning Work|34%|Medium||
...
|[0823](https://leetcode.com/problems/binary-trees-with-factors/)| * Binary Trees With Factors|31%|Medium||
|[0822](https://leetcode.com/problems/card-flipping-game/)| * Card Flipping Game|39%|Medium||
...
|[0819](https://leetcode.com/problems/most-common-word/)| * Most Common Word|41%|Easy||
|[0818](https://leetcode.com/problems/race-car/)| * Race Car|34%|Hard||
|[0817](https://leetcode.com/problems/linked-list-components/)| * Linked List Components|53%|Medium||
...
|[0810](https://leetcode.com/problems/chalkboard-xor-game/)| * Chalkboard XOR Game|43%|Hard||
...
|[0803](https://leetcode.com/problems/bricks-falling-when-hit/)| * Bricks Falling When Hit|27%|Hard||
|[0802](https://leetcode.com/problems/find-eventual-safe-states/)| * Find Eventual Safe States|42%|Medium||
...
|[0794](https://leetcode.com/problems/valid-tic-tac-toe-state/)| * Valid Tic-Tac-Toe State|28%|Medium||
...
|[0792](https://leetcode.com/problems/number-of-matching-subsequences/)| * Number of Matching Subsequences|41%|Medium||
...
|[0783](https://leetcode.com/problems/minimum-distance-between-bst-nodes/)| * Minimum Distance Between BST Nodes|49%|Easy||
|[0782](https://leetcode.com/problems/transform-to-chessboard/)| * Transform to Chessboard|39%|Hard||
|[0781](https://leetcode.com/problems/rabbits-in-forest/)| * Rabbits in Forest|50%|Medium||
...
|[0775](https://leetcode.com/problems/global-and-local-inversions/)| * Global and Local Inversions|37%|Medium||
|[0773](https://leetcode.com/problems/sliding-puzzle/)| * Sliding Puzzle|50%|Hard||
...
|[0764](https://leetcode.com/problems/largest-plus-sign/)| * Largest Plus Sign|42%|Medium||
|[0763](https://leetcode.com/problems/partition-labels/)| * Partition Labels|68%|Medium||
...
|[0761](https://leetcode.com/problems/special-binary-string/)| * Special Binary String|49%|Hard||
...
|[0752](https://leetcode.com/problems/open-the-lock/)| * Open the Lock|44%|Medium||
...
|[0735](https://leetcode.com/problems/asteroid-collision/)| * Asteroid Collision|37%|Medium||
...
|[0730](https://leetcode.com/problems/count-different-palindromic-subsequences/)| * Count Different Palindromic Subsequences|37%|Hard||
...
|[0720](https://leetcode.com/problems/longest-word-in-dictionary/)| * Longest Word in Dictionary|43%|Easy||
...
|[0706](https://leetcode.com/problems/design-hashmap/)| * Design HashMap|54%|Easy||
|[0705](https://leetcode.com/problems/design-hashset/)| * Design HashSet|51%|Easy||
|[0704](https://leetcode.com/problems/binary-search/)| * Binary Search|45%|Easy||
...
|[0692](https://leetcode.com/problems/top-k-frequent-words/)| * Top K Frequent Words|44%|Medium||
...
|[0679](https://leetcode.com/problems/24-game/)| * 24 Game|41%|Hard||
...
|[0674](https://leetcode.com/problems/longest-continuous-increasing-subsequence/)| * Longest Continuous Increasing Subsequence|43%|Easy||
...
|[0669](https://leetcode.com/problems/trim-a-binary-search-tree/)| * Trim a Binary Search Tree|59%|Easy||
...
|[0659](https://leetcode.com/problems/split-array-into-consecutive-subsequences/)| * Split Array into Consecutive Subsequences|39%|Medium||
|[0658](https://leetcode.com/problems/find-k-closest-elements/)| * Find K Closest Elements|37%|Medium||
|[0657](https://leetcode.com/problems/robot-return-to-origin/)| * Robot Return to Origin|70%|Easy||
...
|[0648](https://leetcode.com/problems/replace-words/)| * Replace Words|50%|Medium||
...
|[0640](https://leetcode.com/problems/solve-the-equation/)| * Solve the Equation|39%|Medium||
|[0639](https://leetcode.com/problems/decode-ways-ii/)| * Decode Ways II|24%|Hard||
|[0638](https://leetcode.com/problems/shopping-offers/)| * Shopping Offers|47%|Medium||
...
|[0629](https://leetcode.com/problems/k-inverse-pairs-array/)| * K Inverse Pairs Array|28%|Hard||
|[0628](https://leetcode.com/problems/maximum-product-of-three-numbers/)| * Maximum Product of Three Numbers|45%|Easy||
|[0623](https://leetcode.com/problems/add-one-row-to-tree/)| * Add One Row to Tree|46%|Medium||
...
|[0567](https://leetcode.com/problems/permutation-in-string/)| * Permutation in String|37%|Medium||
|[0566](https://leetcode.com/problems/reshape-the-matrix/)| * Reshape the Matrix|58%|Easy||
|[0565](https://leetcode.com/problems/array-nesting/)| * Array Nesting|51%|Medium||
...
|[0547](https://leetcode.com/problems/friend-circles/)| * Friend Circles|52%|Medium||
...
|[0542](https://leetcode.com/problems/01-matrix/)| * 01 Matrix|34%|Medium||
...
|[0530](https://leetcode.com/problems/minimum-absolute-difference-in-bst/)| * Minimum Absolute Difference in BST|49%|Easy||
|[0529](https://leetcode.com/problems/minesweeper/)| * Minesweeper|51%|Medium||
...
|[0518](https://leetcode.com/problems/coin-change-2/)| * Coin Change 2|41%|Medium||
...
|[0508](https://leetcode.com/problems/most-frequent-subtree-sum/)| * Most Frequent Subtree Sum|53%|Medium||
|[0507](https://leetcode.com/problems/perfect-number/)| * Perfect Number|33%|Easy||
|[0506](https://leetcode.com/problems/relative-ranks/)| * Relative Ranks|47%|Easy||
...
|[0501](https://leetcode.com/problems/find-mode-in-binary-search-tree/)| * Find Mode in Binary Search Tree|38%|Easy||
...
|[0496](https://leetcode.com/problems/next-greater-element-i/)| * Next Greater Element I|58%|Easy||
|[0495](https://leetcode.com/problems/teemo-attacking/)| * Teemo Attacking|51%|Medium||
...
|[0488](https://leetcode.com/problems/zuma-game/)| * Zuma Game|37%|Hard||
...
|[0464](https://leetcode.com/problems/can-i-win/)| * Can I Win|26%|Medium||
...
|[0458](https://leetcode.com/problems/poor-pigs/)| * Poor Pigs|44%|Hard||
...
|[0454](https://leetcode.com/problems/4sum-ii/)| * 4Sum II|49%|Medium||
...
|[0443](https://leetcode.com/problems/string-compression/)| * String Compression|36%|Easy||
...
|[0432](https://leetcode.com/problems/all-oone-data-structure/)| * All O`one Data Structure|28%|Hard||
...
|[0417](https://leetcode.com/problems/pacific-atlantic-water-flow/)| * Pacific Atlantic Water Flow|36%|Medium||
...
|[0412](https://leetcode.com/problems/fizz-buzz/)| * Fizz Buzz|58%|Easy||
|[0410](https://leetcode.com/problems/split-array-largest-sum/)| * Split Array Largest Sum|41%|Hard||
...
|[0399](https://leetcode.com/problems/evaluate-division/)| * Evaluate Division|46%|Medium||
...
|[0376](https://leetcode.com/problems/wiggle-subsequence/)| * Wiggle Subsequence|36%|Medium||
...
|[0355](https://leetcode.com/problems/design-twitter/)| * Design Twitter|26%|Medium||
...
|[0350](https://leetcode.com/problems/intersection-of-two-arrays-ii/)| * Intersection of Two Arrays II|46%|Easy||
|[0349](https://leetcode.com/problems/intersection-of-two-arrays/)| * Intersection of Two Arrays|53%|Easy||
|[0347](https://leetcode.com/problems/top-k-frequent-elements/)| * Top K Frequent Elements|53%|Medium||
|[0345](https://leetcode.com/problems/reverse-vowels-of-a-string/)| * Reverse Vowels of a String|40%|Easy||
|[0344](https://leetcode.com/problems/reverse-string/)| * Reverse String|62%|Easy||
...
|[0318](https://leetcode.com/problems/maximum-product-of-word-lengths/)| * Maximum Product of Word Lengths|47%|Medium||
...
|[0303](https://leetcode.com/problems/range-sum-query-immutable/)| * Range Sum Query - Immutable|36%|Easy||
...
|[0289](https://leetcode.com/problems/game-of-life/)| * Game of Life|43%|Medium||
...
|[0273](https://leetcode.com/problems/integer-to-english-words/)| * Integer to English Words|23%|Hard||
...
|[0233](https://leetcode.com/problems/number-of-digit-one/)| * Number of Digit One|29%|Hard||
...
|[0224](https://leetcode.com/problems/basic-calculator/)| * Basic Calculator|31%|Hard||
...
|[0212](https://leetcode.com/problems/word-search-ii/)| * Word Search II|27%|Hard||
...
|[0210](https://leetcode.com/problems/course-schedule-ii/)| * Course Schedule II|33%|Medium||
...
|[0207](https://leetcode.com/problems/course-schedule/)| * Course Schedule|36%|Medium||
...
|[0199](https://leetcode.com/problems/binary-tree-right-side-view/)| * Binary Tree Right Side View|46%|Medium||
...
|[0188](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-iv/)| * Best Time to Buy and Sell Stock IV|25%|Hard||
...
|[0171](https://leetcode.com/problems/excel-sheet-column-number/)| * Excel Sheet Column Number|50%|Easy||
|[0169](https://leetcode.com/problems/majority-element/)| * Majority Element|51%|Easy||
...
|[0165](https://leetcode.com/problems/compare-version-numbers/)| * Compare Version Numbers|22%|Medium||
|[0164](https://leetcode.com/problems/maximum-gap/)| * Maximum Gap|31%|Hard||
...
|[0155](https://leetcode.com/problems/min-stack/)| * Min Stack|35%|Easy||
...
|[0135](https://leetcode.com/problems/candy/)| * Candy|27%|Hard||
...
|[0131](https://leetcode.com/problems/palindrome-partitioning/)| * Palindrome Partitioning|39%|Medium||
...
|[0118](https://leetcode.com/problems/pascals-triangle/)| * Pascal&#39;s Triangle|44%|Easy||
...
|[0111](https://leetcode.com/problems/minimum-depth-of-binary-tree/)| * Minimum Depth of Binary Tree|34%|Easy||
|[0110](https://leetcode.com/problems/balanced-binary-tree/)| * Balanced Binary Tree|40%|Easy||
|[0109](https://leetcode.com/problems/convert-sorted-list-to-binary-search-tree/)| * Convert Sorted List to Binary Search Tree|39%|Medium||
...
|[0107](https://leetcode.com/problems/binary-tree-level-order-traversal-ii/)| * Binary Tree Level Order Traversal II|45%|Easy||
...
|[0105](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/)| * Construct Binary Tree from Preorder and Inorder Traversal|39%|Medium||
|[0104](https://leetcode.com/problems/maximum-depth-of-binary-tree/)| * Maximum Depth of Binary Tree|59%|Easy||
|[0103](https://leetcode.com/problems/binary-tree-zigzag-level-order-traversal/)| * Binary Tree Zigzag Level Order Traversal|40%|Medium||
|[0102](https://leetcode.com/problems/binary-tree-level-order-traversal/)| * Binary Tree Level Order Traversal|47%|Medium||
|[0101](https://leetcode.com/problems/symmetric-tree/)| * Symmetric Tree|42%|Easy||
...
|[0095](https://leetcode.com/problems/unique-binary-search-trees-ii/)| * Unique Binary Search Trees II|34%|Medium||
|[0094](https://leetcode.com/problems/binary-tree-inorder-traversal/)| * Binary Tree Inorder Traversal|55%|Medium||
|[0093](https://leetcode.com/problems/restore-ip-addresses/)| * Restore IP Addresses|30%|Medium||
|[0092](https://leetcode.com/problems/reverse-linked-list-ii/)| * Reverse Linked List II|34%|Medium||
|[0091](https://leetcode.com/problems/decode-ways/)| * Decode Ways|21%|Medium||
...
|[0064](https://leetcode.com/problems/minimum-path-sum/)| * Minimum Path Sum|45%|Medium||
...
|[0053](https://leetcode.com/problems/maximum-subarray/)| * Maximum Subarray|42%|Easy||
|[0052](https://leetcode.com/problems/n-queens-ii/)| * N-Queens II|50%|Hard||
...
|[0046](https://leetcode.com/problems/permutations/)| * Permutations|53%|Medium||
...
|[0037](https://leetcode.com/problems/sudoku-solver/)| * Sudoku Solver|35%|Hard||
...
|[0027](https://leetcode.com/problems/remove-element/)| * Remove Element|43%|Easy||
|[0026](https://leetcode.com/problems/remove-duplicates-from-sorted-array/)| * Remove Duplicates from Sorted Array|39%|Easy||
...
|[0018](https://leetcode.com/problems/4sum/)| * 4Sum|29%|Medium||
|[0017](https://leetcode.com/problems/letter-combinations-of-a-phone-number/)| * Letter Combinations of a Phone Number|40%|Medium||
|[0016](https://leetcode.com/problems/3sum-closest/)| * 3Sum Closest|41%|Medium||
...
|[0009](https://leetcode.com/problems/palindrome-number/)| * Palindrome Number|42%|Easy||
...
|[0006](https://leetcode.com/problems/zigzag-conversion/)| * ZigZag Conversion|30%|Medium||
...
|[0001](https://leetcode.com/problems/two-sum/)|✅[Two Sum](./practive/leetcode/0001.two-sum)|42%|Easy||
